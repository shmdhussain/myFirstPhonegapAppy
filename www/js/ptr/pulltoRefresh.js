var WebPullToRefresh = (function () {
    ...
    var _doReset = function() {
        ...
        var bodyClassRemove = function() {
            ...
            console.log("reset 2");
            document.body.removeEventListener( transEndEventName, bodyClassRemove, false );
        };

        document.body.addEventListener( transEndEventName, bodyClassRemove, false );
    };
